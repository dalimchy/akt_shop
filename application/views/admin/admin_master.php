...
<html class="app-ui">
    ...
    <head>
        ...
        <!-- Page JS Plugins CSS -->
        <link rel="stylesheet" href="<?php echo base_url()?>assets/admin_assets/assets/js/plugins/slick/slick.min.css" />
        <link rel="stylesheet" href="<?php echo base_url()?>assets/admin_assets/assets/js/plugins/slick/slick-theme.min.css" />
    ...
    <body class="app-ui layout-has-drawer layout-has-fixed-header">
                ...
                <aside class="app-layout-drawer">
                    ...
                    <div class="app-layout-drawer-scroll">
                        ...
                        <div id="logo" class="drawer-header">
                            <a href="index.html"><img class="img-responsive" src="<?php echo base_url()?>assets/admin_assets/assets/img/logo/logo-backend.png" title="AppUI" alt="AppUI" /></a>
                        </div>
        ...
        <!-- Page Plugins -->
        <script src="<?php echo base_url()?>assets/admin_assets/assets/js/plugins/slick/slick.min.js"></script>
        <script src="<?php echo base_url()?>assets/admin_assets/assets/js/plugins/chartjs/Chart.min.js"></script>
        <script src="<?php echo base_url()?>assets/admin_assets/assets/js/plugins/flot/jquery.flot.min.js"></script>
        <script src="<?php echo base_url()?>assets/admin_assets/assets/js/plugins/flot/jquery.flot.pie.min.js"></script>
        <script src="<?php echo base_url()?>assets/admin_assets/assets/js/plugins/flot/jquery.flot.stack.min.js"></script>
        <script src="<?php echo base_url()?>assets/admin_assets/assets/js/plugins/flot/jquery.flot.resize.min.js"></script>

        <!-- Page JS Code -->
        <script src="<?php echo base_url()?>assets/admin_assets/assets/js/pages/index.js"></script>
        <script>
            $(function()
            {
