<div class="body-content">
	...
	<div class="table-responsive">
		<table class="table">
			...
			<tbody>
				<tr>
					<td class="col-md-2"><img src="<?php echo base_url()?>assets/frontend/images/products/p1.jpg" alt="imga"></td>
					<td class="col-md-7">
				...
				<tr>
					<td class="col-md-2"><img src="<?php echo base_url()?>assets/frontend/images/products/p2.jpg" alt="phoro"></td>
					<td class="col-md-7">
						<div class="product-name"><a href="#">Floral Print Buttoned</a></div>
						<div class="rating">
							<i class="fa fa-star rate"></i>
